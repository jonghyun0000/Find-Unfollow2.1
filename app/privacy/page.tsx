    ...
    <>
      ...
      <article className="page-shell py-6 space-y-6 text-sm leading-relaxed text-slate-600">
        <section>
          ...
          <p className="mt-2">
            선택한 인스타그램 JSON 파일은 브라우저 안에서만 처리합니다. 파일 내용이나 분석 결과를
            서비스 서버로 업로드하지 않습니다. 이 사이트에서 인스타그램 로그인이나 비밀번호 입력을
            요구하지 않습니다. 인스타그램에서 원본 파일을 받을 때는 로그인이 필요합니다.
          </p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-slate-900">저장은 선택할 수 있습니다</h2>
          <p className="mt-2">
            업로드 화면에서 기록 저장을 선택하면 데이터 기준일, 팔로워·팔로잉 목록과 기록을 구분하는
            임의 식별자를 이 브라우저에 기록 묶음별로 최대 10개 보관합니다. 아이디는 입력받지
            않습니다. 이전 버전에서 저장한 기록은 가능한 경우 자동으로 옮깁니다. 공용 기기에서는
            저장하지 않는 것을 권장합니다.
          </p>
        </section>
        <section>
