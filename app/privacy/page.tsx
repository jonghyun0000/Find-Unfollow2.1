...
export default function PrivacyPage() {
  return (
    <>
      ...
      <article className="mx-auto max-w-md px-5 py-6 space-y-6 text-sm leading-relaxed text-white/75">
        <section>
          <h2 className="text-lg font-semibold text-white">파일은 기기에서 분석합니다</h2>
          <p className="mt-2">
            선택한 인스타그램 JSON 파일과 계정 아이디는 브라우저 안에서만 처리합니다. 파일 내용이나
            분석 결과를 서비스 서버로 업로드하지 않습니다. 인스타그램 로그인, 비밀번호 또는 API
            연결을 요구하지 않습니다.
          </p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-white">저장은 선택할 수 있습니다</h2>
          <p className="mt-2">
            업로드 화면에서 기록 저장을 선택하면 아이디, 데이터 기준일, 팔로워·팔로잉 목록을 이
            브라우저의 IndexedDB에 계정별 최대 10개 기록으로 보관합니다. 이전 버전의 localStorage
            기록은 가능한 경우 자동으로 옮깁니다. 공용 기기에서는 저장하지 않는 것을 권장합니다.
          </p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-white">삭제와 보관</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-white">네트워크 연결</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-lg font-semibold text-white">결과의 한계</h2>
          <p className="mt-2">
